...
has culinary and cultural significance but no agreed upon botanical or scientific meaning. The term pumpkin is sometimes used interchangeably with "squash" or "winter squash",
...
//! ![Heres the image](https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/FrenchMarketPumpkinsB.jpg/700px-FrenchMarketPumpkinsB.jpg)
...
impl Pumpkin {
    /// If you smash the pumpkin it will be gone and cant be used for pie
    pub fn smash(self) {}
}
...
/// This is for the orangeness in the struct [`Pumpkin`]
